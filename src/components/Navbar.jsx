...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 backdrop-blur-md bg-white/30 dark:bg-slate-900/40 border-b border-white/20 dark:border-slate-800/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <button
            ...
            className="p-2.5 rounded-full bg-white/60 dark:bg-slate-800/60 border border-white/40 dark:border-slate-700 text-slate-700 dark:text-yellow-300 hover:scale-110 transition-transform shadow-md"
          >
